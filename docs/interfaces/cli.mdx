...
The Grat CLI is a Rust-native application designed for speed and reliability. It is the most powerful interface, providing access to all three tiers of diagnostics.
