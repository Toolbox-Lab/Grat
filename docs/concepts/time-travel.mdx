...
Tier 3 is the ultimate investigation path, turning Grat into a full interactive debugger for the Stellar network.
...
Grat runs both the original and modified execution and shows you a side-by-side diff of where they diverge.
