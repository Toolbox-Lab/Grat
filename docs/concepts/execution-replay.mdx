...
To replay a transaction accurately, Grat must reconstruct the exact ledger state that existed at the moment of execution.
...
Grat executes the transaction in a modified Soroban sandbox.
