...
## Finding Hotspots
Use `grat profile <hash>` to identify the most expensive host functions in your transaction.
...
## Verification
After optimizing, use `grat whatif` to re-simulate the transaction with your new contract version to verify the budget reduction before redeploying.
