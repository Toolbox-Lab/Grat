...
description: "How to embed Grat's streaming diagnostics into your applications."
---

Grat provides a flexible WebSocket-based API for real-time transaction tracing. This guide covers how to integrate these capabilities into your own services.
...
### 1. Start the Grat Server
Run the Grat server to expose the WebSocket endpoint:

```bash
grat serve --port 8080 --network mainnet
```
